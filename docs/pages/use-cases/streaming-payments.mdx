...
<Callout type="info">
Testnet is perfect for experimenting with streaming payment patterns. Get free USD tokens from the [Radius Testnet Faucet](https://testnet.radiustech.xyz/testnet/faucet).
</Callout>
