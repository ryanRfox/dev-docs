---
title: JSON-RPC API
description: JSON-RPC 2.0 API reference for interacting with Radius Network
---
...
:::info
On Radius, fees are paid in stablecoins (SBC) rather than a native gas token. This method returns your actual native balance plus the maximum native token you could receive by converting your SBC through the Turnstile mechanism. This supports wallets that check balance before allowing transactions.
:::
