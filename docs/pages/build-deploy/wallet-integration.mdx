...
# Wallet Integration [Connect your web app to Radius using MetaMask, wagmi, viem, and EIP-1193 compatible wallets.]
...
## Use wagmi (recommended for React)

[wagmi](https://wagmi.sh) provides the recommended approach for wallet integration in React applications. The Radius SDK exports a wagmi-compatible chain definition.
...
Gracefully handle common wallet errors:
